...
for i in range(20):
    ...
    #mesiac(465,275+y,50,'dark blue','yellow')
    #mesiac(480,275+y,50,'dark blue','dark blue')
    canvas.create_oval(465,275-y,515,275-y+50,outline='white',fill='yellow')
    canvas.create_oval(480,275-y,515,275-y+50,outline='white',fill='white')
    canvas.create_oval(465,275+y,515,275+y+50,outline='dark blue',fill='yellow')
    canvas.create_oval(480,275+y,515,275+y+50,outline='dark blue',fill='dark blue')
    g=g+10
    canvas.update()
    canvas.after(100)
