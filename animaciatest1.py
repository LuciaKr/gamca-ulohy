...
for i in range(10):
    canvas.delete('idd')
    idd=canvas.create_oval(465,275-y,515,275-y+50,outline='white',fill='yellow')
    idd=canvas.create_oval(480,275-y,530,275-y+50,outline='white',fill='white')
    idd=canvas.create_oval(465,275+y,515,275+y+50,outline='dark blue',fill='yellow')
    idd=canvas.create_oval(480,275+y,530,275+y+50,outline='dark blue',fill='dark blue')
    y=y+10
    canvas.update()
    canvas.after(100)
